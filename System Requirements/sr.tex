...
\item Enable revenue generation for the printer of postcards
\end{enumerate}
...
\newcounter{tasks}
\stepcounter{tasks}
	\item [Req \thesubsubsection {.\thetasks}] The product shall support tasks 1.1 and 1.2.
...
\item[1b] The user selects a picture from PostCardBuddy's standard gallery. 
\item[2a] Include editing of gallery pictures.
...
\stepcounter{product}
\item [Req \thesubsubsection {.\theproduct} Image and GPS position] Images from the standard gallery shall be presented based on the user's GPS position.
\stepcounter{product}
\item [Req \thesubsubsection {.\theproduct} Image editing] The product shall have a function for editing images.
\stepcounter{product}

...
\item[Example:] Camera, GPS etc.
	...
	\stepcounter{interf}
	\item [Req \thesubsubsection {.\theinterf} Payment] The product shall use an external payment service to charge for the services. 
	\begin{description}
	\item[Clarification:] The interface may vary depending on the payment service usedx. 
	\end{description}
\end{description}
...
\begin{description}
\item [Req \thesubsubsection \rprod{req:po-hi1}{.\theproduct} View history] It shall be possible to display sent postcards.

\item [Req \thesubsubsection \rprod{req:po-hi2}{.\theproduct} View recipients] It shall be possible to display the recipients to which a postcard has been sent.

\item [Req \thesubsubsection \rprod{req:po-hi3}{.\theproduct} View date] It shall be possible to display when a postcard was sent. 

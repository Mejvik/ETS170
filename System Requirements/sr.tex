...
\begin{description}
	...
	\item [Req \thesubsubsection \rprod{req:po-di}{.\theproduct} Digital postcard] It shall be possible to send digital postcards.
...
3 & \ref{ssec:product}.\ref{req:po-di} Digital postcard &15\\ \hline

...
\paragraph{History}
\begin{description}
\item [Req \thesubsubsection \rprod{req:po-hi}{.\theproduct} View history] It shall be possible to display which postcards have been sent.

\item [Req \thesubsubsection \rprod{req:po-hi}{.\theproduct} View recipients] It shall be possible to display the recipients to which a postcard has been sent.

\item [Req \thesubsubsection \rprod{req:po-hi}{.\theproduct} View recipients] It shall be possible to display when a postcard was sent to a recipient. 

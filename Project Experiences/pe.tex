...
There is a tool to help the specification or requirement and release planning that was called reqT that was recommended to use in this project. After that the cost and benefit was done in the release plan the data was put into reqT to try and solve the problem. Because of inexperience with the tool it was later decided to abandon the tool and do the release plan manually as it was not so many features to plan.

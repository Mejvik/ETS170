...
To find relevant elicitation techniques, \textit{Software Requirements - Styles and Techniques} by Soren Lauesen has been used as a guidance\cite{soren}. An initial stakeholder analysis was quickly conducted and the different stakeholders were then approached using different elicitation techniques.

The stakeholder analysis was done through discussions within the group. To find out who those were, a discussion was held about who will interact with the system and with whom the system will interact. From that discussion the stakeholders that were the most important ones for this system could be collected. It was important to quickly get going with the project and therefore this "quick and dirty" method for finding the stakeholders was used.
...
\item[Validation checklists and validation report] Validation checklists provided by the developer group were used to validate the product initially ordered as customers. A validation report was then written based on the checklists.
\end{description}

...
Users: Good technical knowledge, used to little manual work. 
...
\item Save pictures to the library.
...
\item[1a] The user selects a picture from the personal library.
\item[1b] The user selects a picture from PostCardBuddys library. 
\item[2a] Include editing of library pictures.
\item[4a] Manually add address.
\item[4b] Copy address from webbrowser.
\end{itemize}
\end{description}
...
\stepcounter{images}
\item [Req \thesubsubsection {.\theimages} Image from PostCardBuddy's gallery] It shall be possible to choose pictures from an existing PostCardBuddy gallery.
\stepcounter{images}

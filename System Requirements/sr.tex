...
Users: Average mobile phone user, used to little manual work. 

\newcounter{tasks}
\stepcounter{tasks}
	\item [Req \thesubsubsection {.\thetasks}] The system shall support tasks 1.1 and 1.2.
...
\stepcounter{product}
\item [Req \thesubsubsection {.\theproduct} Picture from camera] It shall be possible to take a picture with the camera and use as image for the front of the postcard.
\stepcounter{product}
\item [Req \thesubsubsection {.\theproduct} Image from standard library] It shall be possible to choose pictures from the standard library.
\stepcounter{product}
\item [Req \thesubsubsection {.\theproduct} Image and GPS position] Images from the standard library shall be presented based on the user's GPS position.
\stepcounter{product}
\item [Req \thesubsubsection {.\theproduct} Image editing] The system shall have a function for editing images.
\stepcounter{product}
\item [Req \thesubsubsection {.\theproduct} Image saving] It shall be possible to save images.
\end{description}
...
\begin{description}
	...
	\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} Pictures of handwritten greetings] It shall be possible to choose a picture of a hand-written greeting.
	\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} Auto-generated greetings] It shall be possible to choose a template greeting.
	\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} GPS based greetings] The system shall be able to generate greetings based on the GPS position.
	\stepcounter{product} 
	\item [Req \thesubsubsection {.\theproduct} Handwritten greetings on screen] It shall be possible to write a handwritten greeting directly on the screen.
	\stepcounter{product}
...
\begin{description}
	...
	\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} Multiple recipients] The system shall be able to handle multiple recipients for one postcard.
	\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} Favourite recipients] It shall be possible to save recipients as favourites.
	\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} Frequent recipients] The system shall show frequently used recipients as favourite recipients.
\end{description}
...
\FloatBarrier
	...
	The images in figures \ref{fig:p1}-\ref{fig:p4} are from a  prototype and should be used as a guideline rather than as a design requirement.

...
\begin{description}
	...
	\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} Load postcards] It shall be possible to load saved postcards.
	\stepcounter{product}
	...
	\item [Req \thesubsubsection {.\theproduct} Postcard size] It shall be possible to choose between three different sizes of the postcard; small (A6), medium (A5) and large (A4).
	\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} History] It shall be possible to display the history of sent postcards.
	\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} Social media] Feature for sharing postcards on Facebook, Twitter and Instagram.
\end{description}
...
\item [Req \thesubsubsection {.\theproduct} Payment] It shall be possible to pay for sending physical postcards.
	\stepcounter{product}
\item [Req \thesubsubsection {.\theproduct} Price] It shall be possible to view the price before sending the postcard.
	\stepcounter{product}
\item [Req \thesubsubsection {.\theproduct} Currency] It shall be possible to choose the currency for the price to be displayed in.
	\stepcounter{product}
\end{description}
...
\stepcounter{product}
	\item [Req \thesubsubsection {.\theproduct} No internet] If the user places an order on a device that is not connected to the internet, the order shall be stored and the next time the device receives internet connection a notification shall ask the user if he/she wants to try send it again. 
\end{description}
